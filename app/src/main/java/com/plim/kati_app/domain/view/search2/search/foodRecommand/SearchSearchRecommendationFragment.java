package com.plim.kati_app.domain.view.search2.search.foodRecommand;
...
import com.plim.kati_app.domain.katiCrossDomain.domain.view.KatiSearchFragment;
import com.plim.kati_app.domain.view.search2.search.foodRecommand.ranking.FoodRankAdapter;
import com.plim.kati_app.domain.view.search2.search.foodRecommand.recentSearch.SearchHistoryAdapter;

import java.util.Vector;

import static com.plim.kati_app.domain.katiCrossDomain.domain.Constant.SEARCH_WORD_DELETE_ALL_DIALOG_MESSAGE;
import static com.plim.kati_app.domain.katiCrossDomain.domain.Constant.SEARCH_WORD_DELETE_ALL_DIALOG_TITLE;
import static com.plim.kati_app.domain.katiCrossDomain.domain.Constant.SEARCH_WORD_DELETE_ONE_DIALOG_MESSAGE_HEAD;
import static com.plim.kati_app.domain.katiCrossDomain.domain.Constant.SEARCH_WORD_DELETE_ONE_DIALOG_MESSAGE_TAIL;
import static com.plim.kati_app.domain.katiCrossDomain.domain.Constant.SEARCH_WORD_DELETE_ONE_DIALOG_TITLE;

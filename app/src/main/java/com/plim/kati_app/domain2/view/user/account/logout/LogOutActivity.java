package com.plim.kati_app.domain2.view.user.account.logout;
...
import com.plim.kati_app.domain2.view.user.account.login.GoogleLoginActivity;
...
public class LogOutActivity extends AppCompatActivity {
    ...
    public void showOkDialog(){
        KatiDialog.simpleAlertDialog(this, Constant_yun.LOG_OUT_ACTIVITY_SUCCESSFUL_DIALOG_TITLE,
            ...
            Intent intent = new Intent(LogOutActivity.this, TempMainActivity.class);
            startActivity(intent);

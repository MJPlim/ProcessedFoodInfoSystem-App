package com.plim.kati_app.domain2.katiCrossDomain.tech.retrofit;

import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.ModifyPasswordRequest;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.ModifyPasswordResponse;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.FindPasswordRequest;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.FindPasswordResponse;
...
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.WithdrawRequest;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.SignUpResponse;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.SignUpRequest;
import com.plim.kati_app.domain2.katiCrossDomain.domain.model.forBackend.userAccount.WithdrawResponse;

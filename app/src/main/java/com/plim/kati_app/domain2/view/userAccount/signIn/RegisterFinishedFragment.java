...
public class RegisterFinishedFragment extends AbstractFragment1 {
    ...
    protected void initializeView() {
        ...
        this.mainTextView.setText(String.format("%s %s%s", getString(R.string.welcome_start), this.dataset.get(KatiEntity.EKatiData.NAME), getString(R.string.welcome_end)));
